      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="space-y-4">
             <div className="font-black text-xl md:text-2xl text-white tracking-tighter">
          ...
          {/* Links 1 */}
          <div>
            <h4 className="font-bold text-white mb-4 uppercase tracking-wider text-xs md:text-sm">Programs</h4>
          ...
          {/* Newsletter */}
          <div>
            <h4 className="font-bold text-white mb-4 uppercase tracking-wider text-xs md:text-sm">Newsletter</h4>
            <div className="flex flex-col gap-2">
              ...
              />
              <button className="bg-white text-black font-bold text-xs md:text-sm uppercase px-4 py-2 hover:bg-neutral-200 transition-colors w-full md:w-auto">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-neutral-900 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-neutral-600 gap-4 md:gap-0">
          <p className="text-center md:text-left">&copy; {new Date().getFullYear()} CoachHub. All rights reserved.</p>
