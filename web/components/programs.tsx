    ...
    <section className="bg-neutral-950 py-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {programs.map((program, index) => (
            <motion.div
              ...
              className={`relative bg-neutral-900 rounded-2xl overflow-hidden border ${program.popular ? 'border-red-600 shadow-2xl shadow-red-900/20' : 'border-neutral-800'}`}
            >
              {program.popular && (
                <div className="absolute top-0 right-0 bg-red-600 text-white text-xs font-bold px-3 py-1 uppercase tracking-wider rounded-bl-lg z-10">
                  Most Popular
                </div>
              )}
              ...
              <div className="p-8">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <span className="inline-block px-2 py-0.5 rounded text-xs font-medium bg-neutral-800 text-neutral-400 border border-neutral-700">
                      {program.level}
                    </span>
                  </div>
                </div>

                <p className="text-neutral-400 text-sm mb-6 h-12 leading-relaxed">
                  {program.description}
                </p>
                ...
                <div className="mb-8">
                   ...
                   <p className="text-xs text-neutral-500 mt-1">Billed monthly. Cancel anytime.</p>
                </div>
        ...
        <div className="mt-20 text-center">
            <p className="text-neutral-400 mb-6">Not sure which program is right for you?</p>
            <Link href="/contact" className="text-white border-b border-red-600 hover:text-red-500 transition-colors pb-1 font-bold">
                Talk to a Coach <ArrowRight className="inline w-4 h-4 ml-1" />
            </Link>
        </div>
      </div>
    </section>
